  ...
  return (
    <section id="about" className="relative min-h-screen flex flex-col justify-center items-center px-4 sm:px-8 md:px-10 py-14 sm:py-20 overflow-hidden bg-[#0C0C0C]">
      ...
      <FadeIn delay={0.1} x={-80} duration={0.9} className="absolute top-[4%] left-[2%] md:left-[4%] opacity-30">
        <img src={getImageUrl(content.aboutImage1)} alt="Decoration 1" className="w-[120px] sm:w-[160px] md:w-[210px] object-contain pointer-events-none" />
      </FadeIn>

      <FadeIn delay={0.25} x={-80} duration={0.9} className="absolute bottom-[8%] left-[3%] md:left-[6%] opacity-30">
        <img src={getImageUrl(content.aboutImage2)} alt="Decoration 2" className="w-[100px] sm:w-[140px] md:w-[180px] object-contain pointer-events-none" />
      </FadeIn>
      ...
      <div className="absolute bottom-[4%] right-[4%] z-20 hidden xl:flex flex-col gap-6 items-end">
        ...
        <FadeIn delay={0.3} x={40} duration={0.8} className="flex flex-col items-end">
            <div className="flex gap-4 items-center">
                ...
                <img src={getImageUrl(content.founder1Image)} alt={content.founder1Name} className="w-14 h-14 rounded-full object-cover border-2 border-white/10 grayscale hover:grayscale-0 transition-all hover:border-[#d4a373] hover:scale-110 cursor-help" />
            </div>
        </FadeIn>
        <FadeIn delay={0.4} x={40} duration={0.8} className="flex flex-col items-end">
            <div className="flex gap-4 items-center">
                ...
                <img src={getImageUrl(content.founder2Image)} alt={content.founder2Name} className="w-14 h-14 rounded-full object-cover border-2 border-white/10 grayscale hover:grayscale-0 transition-all hover:border-[#d4a373] hover:scale-110 cursor-help" />
            </div>
        </FadeIn>
        <FadeIn delay={0.45} x={40} duration={0.8} className="flex flex-col items-end">
            <div className="flex gap-4 items-center">
                ...
                <img src={getImageUrl(content.managerImage)} alt={content.managerName} className="w-14 h-14 rounded-full object-cover border-2 border-white/10 grayscale hover:grayscale-0 transition-all hover:border-[#d4a373] hover:scale-110 cursor-help" />
            </div>
        </FadeIn>
        ...
        {team.map((member, index) => (
          <FadeIn key={member._id} delay={0.5 + index * 0.1} x={40} duration={0.8} className="flex flex-col items-end">
            <div className="flex gap-4 items-center">
              ...
              <img src={getImageUrl(member.image)} alt={member.name} className="w-14 h-14 rounded-full object-cover border-2 border-white/10 grayscale hover:grayscale-0 transition-all hover:border-[#d4a373] hover:scale-110 cursor-help" />
            </div>
          </FadeIn>
        ))}
      ...
      <div className="xl:hidden flex flex-col items-center mt-10 sm:mt-16 z-20">
         <div className="flex flex-wrap justify-center gap-6 sm:gap-8 mb-8 sm:mb-12">
            ...
            <FadeIn delay={0.3} y={20} className="flex flex-col items-center gap-2">
                <img src={getImageUrl(content.founder1Image)} alt={content.founder1Name} className="w-10 h-10 sm:w-12 sm:h-12 rounded-full object-cover border border-[#d4a373]" />
            ...
            <FadeIn delay={0.4} y={20} className="flex flex-col items-center gap-2">
                <img src={getImageUrl(content.founder2Image)} alt={content.founder2Name} className="w-10 h-10 sm:w-12 sm:h-12 rounded-full object-cover border border-[#d4a373]" />
            ...
            <FadeIn delay={0.45} y={20} className="flex flex-col items-center gap-2">
                <img src={getImageUrl(content.managerImage)} alt={content.managerName} className="w-10 h-10 sm:w-12 sm:h-12 rounded-full object-cover border border-[#d4a373]" />
            ...
            {team.map((member, index) => (
              <FadeIn key={member._id} delay={0.5 + index * 0.1} y={20} className="flex flex-col items-center gap-2">
                  <img src={getImageUrl(member.image)} alt={member.name} className="w-10 h-10 sm:w-12 sm:h-12 rounded-full object-cover border border-[#d4a373]" />
